...
// dynamically populate the table with data from arrays . iterates over eachitem in the 'itemData' array and for each item, inserts a new row into the table. it then popluates each row's cells with information, including the brand, quantity, and price.
for (let i = 0; i < itemData.length; i++) {
