...
app.get('/set_cookie', (req, res) => {
    res.cookie('username', 'Jannel', {maxAge: 3000});
...
app.get("/login", function (request, response) {
    ...
    const login_Form = `
        ...
        function getCookieValue(cookieName) {
            let cookie = document.cookie.split(';'); //split the entire cookie string by ';'
            ...
            window.onload = function() {
                ...
                if (cookie_username) {
                    document.getElementById("welcome_user").innerHTML = 'welcome back' '+cookie_username+'!';
